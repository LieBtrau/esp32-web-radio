...
extern void mFunc_information(uint8_t param);
extern void mFunc_timer_info(uint8_t param);
extern void mFunc_back(uint8_t param);
extern void mFunc_jumpTo_timer_info(uint8_t param);
extern void mFunc_p2(uint8_t param);
extern void mFunc_goToRootMenu(uint8_t param);
extern void mFunc_para(uint8_t param);
extern void mDyn_para(uint8_t line);
extern void mFunc_screensaver(uint8_t param);
extern boolean COND_hide();
...
Adafruit_SSD1305 display(_LCDML_ADAFRUIT_lcd_w, _LCDML_ADAFRUIT_lcd_h, &i2c, OLED_RESET);
...
void setup()
{
  ...
  if ( ! display.begin(_ADAFRUIT_I2C_ADR) ) {
